...
export interface CardNumberElementOptions extends BaseElementOptions {
    /*
     * Placeholder
     */
    placeholder?: string;
...
export interface CardExpiryElementOptions extends BaseElementOptions {
    /*
     * Placeholder
     */
    placeholder?: string;
...
export interface CardCvcElementOptions extends BaseElementOptions {
    /*
     * Placeholder
     */
    placeholder?: string;
...
export type StripeElementOptions = CardElementOptions | CardExpiryElementOptions | CardNumberElementOptions | CardCvcElementOptions | IdealElementOptions | IbanElementOptions;
